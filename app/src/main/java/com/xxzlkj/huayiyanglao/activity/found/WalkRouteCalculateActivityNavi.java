...
public class WalkRouteCalculateActivityNavi extends NaviBaseActivity {
    ...
    public static Intent newIntent(Context context, double endLatitude, double endLongitude) {
        Intent intent = new Intent(context, WalkRouteCalculateActivityNavi.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gaodeLocationUtil.initLocation(this, new AMapLocationListener() {
            ...
            public void onLocationChanged(AMapLocation location) {
                ...
                if (isFirstLocation){
                    ...
                    mAMapNavi.calculateWalkRoute(new NaviLatLng(location.getLatitude(), location.getLongitude()), new NaviLatLng(endLatitude, endLongitude));
       ...
       /* final AMap aMap = mAMapNaviView.getMap();
        ...
        aMap.getUiSettings().setZoomPosition(14);
