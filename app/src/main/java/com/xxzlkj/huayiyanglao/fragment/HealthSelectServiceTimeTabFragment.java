...
import com.xxzlkj.huayiyanglao.activity.HealthSelectServiceTimeActivity;
 ...
 *         2017/3/20 16:37
 */
public class HealthSelectServiceTimeTabFragment extends ReuseViewFragment {
     ...
     */
    public static HealthSelectServiceTimeTabFragment newInstance(Bundle args, List<ScheduleBean.TimeBean> time, ScheduleBean.TimeBean selectTimeBean) {
        HealthSelectServiceTimeTabFragment fragment = new HealthSelectServiceTimeTabFragment();
    ...
    public void setListener() {
        adapter.setOnItemClickListener((position, item) -> {
            ...
            if ("2".equals(item.getState()) || "2".equals(item.getTimePeriodState())) {
                ...
                // 设置选中
                ((HealthSelectServiceTimeActivity) mActivity).setSelectBean(item, position);
            }
        });
    }
