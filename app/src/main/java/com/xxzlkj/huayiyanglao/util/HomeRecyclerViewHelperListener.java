 ...
 *         2017/11/17 9:31
 */
public class HomeRecyclerViewHelperListener extends RecyclerView.OnScrollListener {
    private final RecyclerView recyclerView;
    private final LinearLayoutManager layoutManager;
    private boolean move;
    private int mIndex;

    public HomeRecyclerViewHelperListener(RecyclerView recyclerView, LinearLayoutManager layoutManager) {
        ...
        if (move) {
            ...
            if (0 <= n && n < this.recyclerView.getChildCount()) {
                ...
                if (layoutManager.getOrientation() == LinearLayoutManager.VERTICAL) {
                    ...
                    //最后的移动
                    this.recyclerView.scrollBy(0, top - getHeaderHeight(recyclerView.getContext()));
                } else {
                    // 水平的
    ...
    public void scrollToPosition(int position) {
        ...
        if (position < firstItem) {
            ...
            if (layoutManager.getOrientation() == LinearLayoutManager.VERTICAL) {
                ...
                recyclerView.scrollBy(0, top - getHeaderHeight(recyclerView.getContext()));
            } else {
                // 水平滚动
    ...
    private int getHeaderHeight(Context context) {
        return context.getResources().getDimensionPixelOffset(R.dimen.home_content_header_height);
    }
}