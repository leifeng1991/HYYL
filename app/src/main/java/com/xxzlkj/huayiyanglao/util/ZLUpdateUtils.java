...
//                    ToastManager.showMsgToast(activity, "已是最新版本");
//                }
            }
        });
    }
    ...
    public static void checkIsVersionUpdate(final VersionUpdateListener listener) {
        ...
        stringStringHashMap.put("uid", loginUser == null ? "" : loginUser.getData().getId());
        stringStringHashMap.put("jpushid", loginUser == null ? "" : registrationID);
