...
public abstract class MyBaseActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SystemBarUtils.setStatusBarColor(this, ContextCompat.getColor(mContext, R.color.white_fafbfd));
        SystemBarUtils.setStatusBarLightMode(this, true);
        View titleBar = findViewById(R.id.titleBar);
        if (titleBar != null)
            titleBar.setBackgroundColor(ContextCompat.getColor(mContext, R.color.white_fafbfd));
