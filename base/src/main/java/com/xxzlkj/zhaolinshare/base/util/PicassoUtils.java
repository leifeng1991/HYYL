...
public class PicassoUtils {
    ...
    public static final String SIGN_BIG = "?sign=";
    ...
    public static void setImageBigHasCallBack(Context context, String imgUrl, ImageView imageView, RequestListener<Drawable> listener) {
        if (!TextUtils.isEmpty(imgUrl)) {
            ...
            getImageSignatureInMainThread(context, new OnGetImageSignatureListener() {
                ...
                public void onSuccess(String sign) {
                    // 获取签名成功，下载图片
                    setImageRawHasCallBack(context, imgUrl + SIGN_BIG + sign, imageView, listener);
                }
