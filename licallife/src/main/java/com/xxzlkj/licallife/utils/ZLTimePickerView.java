...
import com.xxzlkj.licallife.weight.ZLWheelTime;
...
/**
 * 时间选择器--兆邻的选择月日时分（分钟只显示半小时）的
 * Created by Sai on 15/11/22.
 * Updated by XiaoSong on 2017-2-22.
 */
public class ZLTimePickerView extends BasePickerView implements View.OnClickListener {
    private int layoutRes;
    private CustomListener customListener;


    ZLWheelTime wheelTime; //自定义控件
    ...
    //构造方法
    public ZLTimePickerView(Builder builder) {
    ...
    public static class Builder {
        ...
        public ZLTimePickerView build() {
            return new ZLTimePickerView(this);
        }
    }
    ...
    private void initView(Context context) {
        ...
        wheelTime = new ZLWheelTime(timePickerView, type, gravity, Size_Content);
