...
public class RatingBar extends View {
    ...
    private void parseAttrs(AttributeSet attrs) {
        ...
        borderColor = arr.getColor(R.styleable.RatingBar_srb_borderColor, getResources().getColor(R.color.golden_stars));
        ...
        starBorderWidth = arr.getFloat(R.styleable.RatingBar_srb_starBorderWidth, 1f);
        starCornerRadius = arr.getFloat(R.styleable.RatingBar_srb_starCornerRadius, 2f);
        ...
        isClick = arr.getBoolean(R.styleable.RatingBar_srb_isClick, false);
