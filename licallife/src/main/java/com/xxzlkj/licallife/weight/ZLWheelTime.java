...
import com.xxzlkj.licallife.adapter.MinutesWheelAdapter;
...
/**
 * --兆邻的选择月日时分（分钟只显示半小时）的
 */
public class ZLWheelTime {
    ...
    public ZLWheelTime(View view, Type type, int gravity, int textSize) {
        super();
        this.view = view;
        this.type = type;
    ...
    public void setPicker(int year, final int month, int day, int h, int m, int s) {
     ...
     /*   wv_month.setLabel(context.getString(R.string.pickerview_month));*/
      ...
      /*  wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字*/
        ...
        wv_mins.setAdapter(new MinutesWheelAdapter());
