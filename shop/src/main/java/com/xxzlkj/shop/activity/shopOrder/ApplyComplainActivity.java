 ...
 * @author zhangrq
 */
public class ApplyComplainActivity extends MyBaseActivity {
    ...
    private void getNetData() {
        ...
        RequestManager.createRequest(URLConstants.COMPLAIN_SHOP_GROUP_URL, stringStringHashMap, new OnMyActivityRequestListener<complainShopGroupBean>(this) {
            @Override
...
//        simg	多图 图片之间用逗号隔开
        ...
        RequestManager.createRequest(URLConstants.ADD_SHOP_COMPLAIN_URL, stringStringHashMap, new OnMyActivityRequestListener<BaseBean>(this) {
            @Override
    ...
    public static Intent newIntent(Context context, String orderId) {
        Intent intent = new Intent(context, ApplyComplainActivity.class);
