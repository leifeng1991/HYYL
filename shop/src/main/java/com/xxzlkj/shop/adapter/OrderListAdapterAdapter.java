...
public class OrderListAdapterAdapter extends BaseAdapter<OrderListBean.DataBean.GoodsBean> {

    public OrderListAdapterAdapter(Context context, int itemId) {
    ...
    public void convert(BaseViewHolder holder, int position, OrderListBean.DataBean.GoodsBean itemBean) {
        ...
        CustomButton id_advance = holder.getView(R.id.id_advance);// 预售/团购
